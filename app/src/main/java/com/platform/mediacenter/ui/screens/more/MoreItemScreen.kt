package com.platform.mediacenter.ui.screens.more
...
@Composable
fun MoreItemScreen(navController: NavHostController, viewModel: MovieViewModel = hiltViewModel()) {
                ...
                LazyVerticalGrid(
                    ...
                    itemsIndexed(movieList) { index, item ->
                        ...
                        MovieItemBox(
                            ...
                            val actionType = if(movieList[index]!!.isTvseries == "1") "tvseries" else "movie"

                            navController.navigate(
                                Screen.Detail.withArg(
                                    movieList[index]!!.videosId!!,actionType
                                )
                            )
